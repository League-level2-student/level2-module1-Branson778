...
public class VisualArrayLists implements ActionListener {
	...
	public void addThingsToList() {
		...
		if(list.contains("Error: Source Not Found")) {
			System.out.println("This List Contains |Error: Source Not Found|.");
		}
		else {
			System.out.println("The List Does Not Include |Error: Source Not Found|.");
		}
